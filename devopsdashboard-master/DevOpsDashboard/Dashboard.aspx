<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="DevOpsDashboard.Dashboard" %>
...
<head runat="server">
    ...
    <script src="files/dasboard/data.js"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="base" class="" style="font-family:Calibri;font-size :15px">
            ...
            <!-- CapProjRolover (Dynamic Panel) -->
            <div id="u6" class="ax_dynamic_panel" data-label="CapProjRolover">
            ...
            <!-- menu_mobility (Dynamic Panel) -->
            <div id="u18" class="ax_dynamic_panel" data-label="menu_mobility">
            ...
            <!-- hotspot_mobility_menu (Hot Spot) -->
            <div id="u28" class="ax_hot_spot" data-label="hotspot_mobility_menu">
            </div>

            <!-- menu_desktop_laptop (Dynamic Panel) -->
            <div id="u29" class="ax_dynamic_panel" data-label="menu_desktop_laptop">
            ...
            <!-- menu_collaboration (Dynamic Panel) -->
            <div id="u39" class="ax_dynamic_panel" data-label="menu_collaboration">
                <div id="u39_state0" class="panel_state" data-label="State1">
                    <div id="u39_state0_content" class="panel_state_content">
                        ...
                        <!-- Unnamed (Hot Spot) -->
                        <div id="u48" class="ax_hot_spot">
                        </div>

                        <!-- Unnamed (Hot Spot) -->
                        <div id="u49" class="ax_hot_spot">
                        </div>
                    </div>
                </div>
            </div>

            <!-- menu_emit (Dynamic Panel) -->
            <div id="u50" class="ax_dynamic_panel" data-label="menu_emit">
            ...
            <!-- Unnamed (Hot Spot) -->
            <div id="u59" class="ax_hot_spot">
            </div>

            <!-- Unnamed (Hot Spot) -->
            <div id="u60" class="ax_hot_spot">
            </div>

            <!-- Unnamed (Hot Spot) -->
            <div id="u61" class="ax_hot_spot">
            </div>
            ...
            <!-- Unnamed (Hot Spot) -->
            <div id="u65" class="ax_hot_spot">
            </div>

            <!-- Unnamed (Image) -->
            <div id="u66" class="ax_image">
                <img id="u66_img" class="img " src="images/login/u10.jpg" />
                <!-- Unnamed () -->
                <div id="u67" class="text"></div>
            </div>

            <!-- hotspot_mobility_menu (Hot Spot) -->
            <div id="u68" class="ax_hot_spot" data-label="hotspot_mobility_menu">
            </div>
            ...
            <div id="u75" class="ax_paragraph">
                ...
                <div id="u76" class="text">
                    <p><span>Welcome John Mecom</span></p>
                </div>
            </div>
            ...
            <div id="u83" class="ax_image">
                <img id="u83_img" class="img " src="images/home/u83.png" />
                <!-- Unnamed () -->
            ...
            <div id="u85" class="ax_image">
                <img id="u85_img" class="img " src="images/home/u85.png" />
                <!-- Unnamed () -->
            ...
            <div id="u87" class="ax_image">
                <img id="u87_img" class="img " src="images/home/u87.png" />
                <!-- Unnamed () -->
            ...
            <div id="u89" class="ax_paragraph">
                ...
                <div id="u90" class="text">
                    <p><span>Find Products and Support</span></p>
                </div>
            </div>
            ...
            <div id="u95" class="ax_paragraph">
                ...
                <div id="u96" class="text">
                    <p><span>|&nbsp; Call 888-555-1212</span></p>
                </div>
            </div>
            ...
            <div id="u101" class="ax_shape">
                <img id="u101_img" class="img " src="images/dasboard/u101.png" />
                <!-- Unnamed () -->
            ...
            <div id="u103" class="ax_paragraph">
                ...
                <div id="u104" class="text">
                    <p><span>New &amp; Recommended</span></p>
                </div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u105" class="ax_paragraph reg_text">
                <img id="u105_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u106" class="text">
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #333333;">&nbsp; </span><span style="color: #0099CC;">Rest My Password</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; Restore My Mailbox</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; Complete a Survey</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; Open a Service Ticket</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; Track a Service Ticket</span></p>
                </div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u107" class="ax_shape">
                <img id="u107_img" class="img " src="images/dasboard/u107.png" />
                <!-- Unnamed () -->
            ...
            <div id="u109" class="ax_paragraph">
                ...
                <div id="u110" class="text">
                    <p><span>Manager Links</span></p>
                </div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u111" class="ax_paragraph reg_text">
                <img id="u111_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u112" class="text">
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #333333;">&nbsp; </span><span style="color: #0099CC;">Telecommunications</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; Onboarding a New </span></p>
                    <p><span style="color: #0099CC;">&nbsp; &nbsp; Employee</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; My Report</span></p>
                </div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u113" class="ax_shape">
                <img id="u113_img" class="img " src="images/dasboard/u113.png" />
                <!-- Unnamed () -->
            ...
            <!-- Unnamed (Shape) -->
            <div id="u118" class="ax_paragraph">
                <img id="u118_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u119" class="text">
                    <p><span>Quick Order</span></p>
                </div>
            </div>

            <!-- Unnamed (Text Field) -->
            <div id="u120" class="ax_text_field">
                <input id="u120_input" type="text" value="What are you looking for?" />
            </div>
            ...
            <div id="u135" class="ax_paragraph">
                ...
                <div id="u136" class="text">
                    <p><span>Self Assistance</span></p>
                </div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u157" class="ax_shape">
                <img id="u157_img" class="img " src="images/dasboard/u157.png" />
                <!-- Unnamed () -->
                <div id="u158" class="text"></div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u159" class="ax_paragraph">
                <img id="u159_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u160" class="text">
                    <p><span>Security &amp; Controls</span></p>
                </div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u161" class="ax_paragraph reg_text">
                <img id="u161_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u162" class="text">
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #333333;">&nbsp; </span><span style="color: #0099CC;">Archer Dashboard</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; Pending Approvals</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; Redbook &amp; Bluebook</span></p>
                </div>
            </div>
            ...
            <div id="u163" class="ax_image">
                <img id="u163_img" class="img " src="images/dasboard/u163.png" />
                <!-- Unnamed () -->
            ...
            <!-- Unnamed (Shape) -->
            <div id="u167" class="ax_paragraph reg_text">
                <img id="u167_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u168" class="text">
                    <p><span>&#149;</span><span>&nbsp; </span><span>RRR active and availble today</span></p>
                    <p><span>&#149;&nbsp; </span><span>Coming soon.. </span><span>Learn about the roadmap for big data </span></p>
                    <p><span>&nbsp;&nbsp; analytics</span></p>
                    <p><span>&#149;&nbsp; S&amp;C automation to go live April 2nd</span></p>
                </div>
            </div>
            ...
            <!-- Unnamed (Image) -->
            <div id="u169" class="ax_image">
                <img id="u169_img" class="img " src="images/dasboard/u163.png" />
                <!-- Unnamed () -->
                <div id="u170" class="text"></div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u171" class="ax_paragraph">
                <img id="u171_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u172" class="text">
                    <p><span>Self-Service Guides</span></p>
                </div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u173" class="ax_paragraph reg_text">
                <img id="u173_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u174" class="text">
                    <p><span style="color: #333333;">&#149;&nbsp; </span><span style="color: #0099CC;">Service Offerings</span></p>
                    <p><span style="color: #333333;">&#149;&nbsp; </span><span style="color: #0099CC;">Financial Transparency</span></p>
                    <p><span style="color: #333333;">&#149;&nbsp; </span><span style="color: #0099CC;">Service Contestibility</span></p>
                </div>
            </div>

            <!-- Unnamed (Image) -->
            <div id="u175" class="ax_image">
                <img id="u175_img" class="img " src="images/dasboard/u163.png" />
                <!-- Unnamed () -->
            ...
            <!-- Unnamed (Shape) -->
            <div id="u179" class="ax_paragraph reg_text">
                <img id="u179_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u180" class="text">
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #333333;">&nbsp; </span><span style="color: #0099CC;">Enroll now in your 2014 safety training</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; Learn how to leverage mobile devices for your capital </span></p>
                    <p><span style="color: #0099CC;">&nbsp; &nbsp; projects</span></p>
                    <p><span style="color: #5E5E5E;">&#149;</span><span style="color: #0099CC;">&nbsp; </span><span style="color: #0099CC;">Outlook for Energy: A View to 2040</span></p>
                </div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u181" class="ax_paragraph reg_text">
                <img id="u181_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u182" class="text">
                    <p><span>View all New &amp; Recommended</span></p>
                </div>
            </div>

            <!-- Unnamed (Image) -->
            <div id="u183" class="ax_image">
                <img id="u183_img" class="img " src="images/dasboard/u163.png" />
                <!-- Unnamed () -->
                <div id="u184" class="text"></div>
            </div>

            <!-- Unnamed (Shape) -->
            <div id="u185" class="ax_paragraph">
            ...
            <!-- Unnamed (Shape) -->
            <div id="u187" class="ax_paragraph reg_text">
                <img id="u187_img" class="img " src="resources/images/transparent.gif" />
                <!-- Unnamed () -->
                <div id="u188" class="text">
                    <p><span style="color: #333333;">&#149;&nbsp; </span><span style="color: #0099CC;">Why use an external service?</span></p>
                    <p><span style="color: #333333;">&#149;&nbsp; </span><span style="color: #0099CC;">What's the real cost to ExxonMobil for my service?</span></p>
                    <p><span style="color: #333333;">&#149;&nbsp; </span><span style="color: #0099CC;">How can I decommision my IT services but keep my </span></p>
                    <p><span style="color: #0099CC;">&nbsp; &nbsp; data?</span></p>
                </div>
            </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div id="u199" class="ax_paragraph">
                        <div>
                            <%--<table style="width: 700px; border-style: inset">--%>
                            <table class="ax_paragraph" style="border-radius: 10px; width: 720px; border-style: inset; border-width: thin; border-color: lightgrey">

                                <tr>
                                    <td>
                                        <div class="ax_droplist">
                                            <br>
                                            <span class="ax_h4">GIT Repository:</span>
                                            ...
                                            <span class="ax_html_button">
                                                <asp:Button ID="Button1" class="ax_html_button" runat="server" Text="Refresh" OnClick="ddlProjects_SelectedIndexChanged" />
                                            </span>
                                ...
                                <tr>
                                    <td class="ax_h4">
                                        <label id="GitHistorylabel" runat="server">
                                            <br>
                                            GIT Commit History:</label></td>
                                </tr>
                                ...
                                <tr>
                                    <td><span class="ax_html_button">
                                               
                                                <asp:LinkButton ID="lnlNaviagte" runat="server" Text="View Job History" OnClick="btnNavigate_Click"></asp:LinkButton>
                                            </span></td>
                                </tr>
